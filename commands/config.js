...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      await interaction.editReply({ content: '❌ Failed to save config. Check logs for details.', ephemeral: true });
    }
  }
};
      ...
      await interaction.editReply({ content: '❌ An error occurred while saving the config.', ephemeral: true });
    }